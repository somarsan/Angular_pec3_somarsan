...
export class PostFormComponent implements OnInit {
  ...
  constructor(
    ...
    this.titlePost = new FormControl(this.post.title, [
      Validators.required,
      Validators.maxLength(55),
    ]);

    this.descriptionPost = new FormControl(this.post.description, [
      Validators.required,
    ...
    this.store.select('posts').subscribe((posts) => {
      ...
      this.titlePost.setValue(this.post.title);

      this.descriptionPost.setValue(this.post.description);
